...
import TestimonialsSlider from "../components/UI/slider/TestimonialsSlider.jsx";
              ...
              <div className="why__tasty-treat">
                ...
                <ListGroup className="mt-5">
                  <ListGroupItem className="border-0 ps-0">
                    ...
                    <p className="choose__us-desc">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quia, voluptatibus.</p>
                  </ListGroupItem>

                  <ListGroupItem className="border-0 ps-0">
                    <p className="choose__us-title d-flex align-items-center gap-2 "><i className="ri-checkbox-circle-line"></i> Quality support</p>
                    <p className="choose__us-desc">Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui, earum.</p>
                  </ListGroupItem>
      ...
      <section className="pt-0">
        <Container>
          <Row>
            ...
            {hotPizza.map((item) => (
              <Col lg="3" md="4" key={item.id} className="mb-3">
                <ProductCard item={item} />
              </Col>
            ))}
          </Row>
          ...
          <Row>
            <Col lg="6" md="6">
              <div className="testimonial">
                ...
                <p className="testimonial__desc">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Distinctio quasi qui minus quos sit perspiciatis inventore quis provident placeat fugiat!</p>
                <TestimonialsSlider />
              </div>
            </Col>
            <Col lg="6" md="6">
