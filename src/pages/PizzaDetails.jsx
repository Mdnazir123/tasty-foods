      ...
      <section>
        <Container>
          <Row>
            ...
            <Col lg='12'>
              {/* { this is me comment code this is error Nazir } */}
            ...
            <Col lg="12">
              <div className="tabs d-flex align-items-center gap-5 py-3">
                <h6 className={`${tab === 'desc' ? 'description tab__active' : 'description'}`} onClick={() => setTab('desc')}>Description</h6>
                <h6 className={`${tab === 'rev' ? 'reviews tab__active' : 'reviews'}`} onClick={() => setTab('rev')}>Review</h6>
              </div>
              {tab === 'desc' ? <div className="description__content tab__content">
                <p>{desc}</p>
              </div> :
                <div className="tab__form mb-3">
                  ...
                  <form className="form" onSubmit={submitHandler}>
                    ...
                    <div className="form__group">
                      <textarea rows="5" type="text" placeholder="Write your review" onChange={e => setreviewMsg(e.target.value)} required></textarea>
                    </div>
